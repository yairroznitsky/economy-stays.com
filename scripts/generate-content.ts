    ...
    messages: [
      {
        role: "system",
        content:
          "You generate SEO landing page content for hotel comparison pages. Output valid JSON with keys: h1, subtitle, metaTitle, metaDescription, introText, faqs, benefits, ctaText.",
      },
...
const buildSearchDefaults = (city: CityRow) => ({
  destinationQuery: `${city.name}, ${city.country}`,
  nightsOffsetDays: 7,
  stayNights: 2,
  adults: 2,
  rooms: 1,
